...
class MiscCommands : Extension(){
        ...
        publicSlashCommand {
            ...
            publicSubCommand(::ConfigSetArgs){
                ...
                action {
                    ...
                    if (arguments.alertLogs == null && arguments.modLogs == null && arguments.joinAndLeaveLogs == null && arguments.inviteCode == null) {
            ...
            publicSubCommand(::ConfigRemoveArgs){
                name = "remove"
                description = "Remove config values, by default it clears all configs. If any arg is set to false it will not touch that"
                guild(TEST_SERVER_ID)
                ...
                action {
                    ...
                    if (arguments.alertLogs == null && arguments.modLogs == null && arguments.joinAndLeaveLogs == null && arguments.inviteCode == null) {
                        putToHashMap(guild!!.id.toLong(), GuildConfigData(null,null,null,null))
    ...
    suspend fun getInviteLink(channel: TextChannel, guild: GuildBehavior) : String{
        return "https://discord.gg/" + suspend{ guildConfigDataMap[guild.id.toLong()]?.invite
                    ?:channel.invites.firstOrNull()
                    ?: guild.invites.firstOrNull()
